function aboutYTm15() {
    ...
    headerTitle.setAttribute("aria-label", "About 2015YouTube (Mirror)");
    headerTitle.textContent = "About 2015YouTube (Mirror)";
...
Changelog
    ...
    <h4 class="ap-footer-text small subhead" id="ap-footer-copyright-and-copyleft-text">© 2015-2019, YouTube and Google | (ↄ) 2024-2025, Yacine's remakes | Mirrored by Entinty1999</h4>
